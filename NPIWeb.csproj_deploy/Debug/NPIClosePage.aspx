                        ...
                        <tr>
                            <td>
                                <table width="95%" height="23" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td valign="bottom">
                                            <asp:Label ID="Label1" SkinID="TitleSkin" runat="Server" Text="管理者頁面"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td align="right">
                                ...
                                <asp:Panel ID="pnlEdit" runat="Server" Visible="false">
                                    ...
                                    <asp:LinkButton ID="lnkPrint" runat="server" CssClass="func" Visible="false" Text="下載Excel" OnClick="lnkPrint_Click" ></asp:LinkButton>
