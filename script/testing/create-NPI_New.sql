create table shinewave.NPI_BOM
(
...
comment on column shinewave.NPI_BOM.USER_ID is '員工帳號';
comment on column shinewave.NPI_BOM.BOM_ID  is 'BOM 型號';
comment on column shinewave.NPI_BOM.BOM_NAME  is 'BOM名稱';
comment on column shinewave.NPI_BOM.BOM_STATUS  is 'BOM 狀態';
comment on column shinewave.NPI_BOM.BOM_DESC  is 'BOM 說明';
comment on column shinewave.NPI_BOM.BOM_REVISION  is 'BOM 版本';
comment on column shinewave.NPI_BOM.RD_EMP_ID  is 'RD 員工帳號';
comment on column shinewave.NPI_BOM.RD_EMP_NAME  is 'RD 員工姓名';
comment on column shinewave.NPI_BOM.RD_EMP_PHONENO  is 'RD 員工分機';
comment on column shinewave.NPI_BOM.PVT_QTY  is 'PVT 數量';
comment on column shinewave.NPI_BOM.PVT_TIME  is 'PVT 時間';
comment on column shinewave.NPI_BOM.PVT_LOCATION  is 'PVT 生產地';
comment on column shinewave.NPI_BOM.MP_TIME  is 'MP 大量生產時間';
comment on column shinewave.NPI_BOM.MP_Q1_QTY  is 'MP Q1 數量';
comment on column shinewave.NPI_BOM.MP_Q2_QTY  is 'MP Q2 數量';
comment on column shinewave.NPI_BOM.CREATE_USER  is '建立人員';
comment on column shinewave.NPI_BOM.CREATE_DATE  is '建立時間';
comment on column shinewave.NPI_BOM.UPDATE_USER  is '更新人員';
comment on column shinewave.NPI_BOM.UPDATE_DATE  is '更新時間';
comment on column shinewave.NPI_BOM.IS_ENABLE  is '是否使用';
comment on column shinewave.NPI_BOM.COMPANY_ID  is '公司代號';

alter table shinewave.NPI_BOM  add constraint PK_BOM primary key (USER_ID, BOM_ID)
  using index ;


create table shinewave.NPI_FORM_MAIN
(
...
comment on table shinewave.NPI_FORM_MAIN  is 'NPI 表單主檔';
comment on column shinewave.NPI_FORM_MAIN.FORM_ID  is '表單代號(yyyyMMddHHmmss)';
comment on column shinewave.NPI_FORM_MAIN.FORM_DATE  is '表單產生日期';
comment on column shinewave.NPI_FORM_MAIN.CREATE_USER  is '新增人員';
comment on column shinewave.NPI_FORM_MAIN.CREATE_DATE  is '新增日期';
comment on column shinewave.NPI_FORM_MAIN.FORM_STATUS  is 'FORM狀態N=尚未結案 Y=已結案';

alter table shinewave.NPI_FORM_MAIN
  add constraint PK_NPI_FORM_MAIN primary key (FORM_ID)
  using index ;


create table shinewave.NPI_BOM_PN
(
  FORM_ID     NVARCHAR2(20) not null,
...
comment on column shinewave.NPI_BOM_PN.FORM_ID  is 'Form代號';
comment on column shinewave.NPI_BOM_PN.WORK_NO  is '產生代號';
comment on column shinewave.NPI_BOM_PN.ASUS_BOM  is 'BOM';
comment on column shinewave.NPI_BOM_PN.ASUS_PN  is '元件料號';
comment on column shinewave.NPI_BOM_PN.ASMBLY_QTY  is '組合用料';
comment on column shinewave.NPI_BOM_PN.CREATE_USER  is '新增人員';
comment on column shinewave.NPI_BOM_PN.CREATE_DATE  is '新增日期';
comment on column shinewave.NPI_BOM_PN.UPDATE_USER  is '更新人員';
comment on column shinewave.NPI_BOM_PN.UPDATE_DATE  is '更新日期';

alter table shinewave.NPI_BOM_PN
  add constraint PK_NPI_BOM_PN primary key (FORM_ID, ASUS_BOM, ASUS_PN)
  using index;
  
alter table shinewave.NPI_BOM_PN
  add constraint FK_NPI_BOM_PN_FORM foreign key (FORM_ID)
  references shinewave.NPI_FORM_MAIN (FORM_ID);


create table shinewave.NPI_BOOKING
(
  USER_ID      NVARCHAR2(20) not null,
  BOM_ID       NVARCHAR2(20) not null,
...
comment on table shinewave.NPI_BOOKING  is 'BOM BOOKING 資料表';
comment on column shinewave.NPI_BOOKING.USER_ID  is 'PM員工帳號';
comment on column shinewave.NPI_BOOKING.BOM_ID  is 'BOM 代號';
comment on column shinewave.NPI_BOOKING.FORM_ID  is '展BOM 的單號';
comment on column shinewave.NPI_BOOKING.WORK_STATUS  is '目前狀態';
comment on column shinewave.NPI_BOOKING.BOOKING_DATE  is 'BOOKING 時間';
comment on column shinewave.NPI_BOOKING.CREATE_USER  is '建立人員';
comment on column shinewave.NPI_BOOKING.CREATE_DATE  is '建立時間';
comment on column shinewave.NPI_BOOKING.UPDATE_USER  is '更新人員';
comment on column shinewave.NPI_BOOKING.UPDATE_DATE  is '更新時間';
comment on column shinewave.NPI_BOOKING.COMPANY_ID  is 'PM所在公司';

alter table shinewave.NPI_BOOKING
  add constraint PK_BOMBOOKING primary key (USER_ID, BOM_ID)
  using index ;


create table shinewave.NPI_PN_ADD2SOURCE
(
...
comment on column shinewave.NPI_PN_ADD2SOURCE.SOURCE_ID  is '第二來源代號';
comment on column shinewave.NPI_PN_ADD2SOURCE.SOURCE_NAME  is '第二來源名稱';
comment on column shinewave.NPI_PN_ADD2SOURCE.IS_ENABLE  is '是否啟用';
comment on column shinewave.NPI_PN_ADD2SOURCE.CREATE_USER  is '新增人員';
comment on column shinewave.NPI_PN_ADD2SOURCE.CREATE_DATE  is '新增日期';
comment on column shinewave.NPI_PN_ADD2SOURCE.UPDATE_USER  is '更新人員';
comment on column shinewave.NPI_PN_ADD2SOURCE.UPDATE_DATE  is '更新日期';

alter table shinewave.NPI_PN_ADD2SOURCE
  add constraint PK_NPI_PN_ADD2SOURCE primary key (SOURCE_ID)
  using index ;


create table shinewave.NPI_PN_PROPERTY
(
...
comment on column shinewave.NPI_PN_PROPERTY.PROPERTY_ID  is '屬性代號';
comment on column shinewave.NPI_PN_PROPERTY.PROPERTY_NAME  is '屬性名稱';
comment on column shinewave.NPI_PN_PROPERTY.IS_ENABLE  is '是否啟用';
comment on column shinewave.NPI_PN_PROPERTY.CREATE_USER  is '新增人員';
comment on column shinewave.NPI_PN_PROPERTY.CREATE_DATE  is '新增日期';
comment on column shinewave.NPI_PN_PROPERTY.UPDATE_USER  is '更新人員';
comment on column shinewave.NPI_PN_PROPERTY.UPDATE_DATE  is '更新日期';

alter table shinewave.NPI_PN_PROPERTY
  add constraint PK_PN_PROPERTY primary key (PROPERTY_ID)
  using index;


create table shinewave.NPI_FORM_PN
(
  FORM_ID             NVARCHAR2(20) not null,
  ASUS_PN             NVARCHAR2(60) not null,
...
comment on column shinewave.NPI_FORM_PN.FORM_ID  is '展開fORM ID';
comment on column shinewave.NPI_FORM_PN.ASUS_PN  is '元件料號';
comment on column shinewave.NPI_FORM_PN.PART_DESC1  is '品名';
comment on column shinewave.NPI_FORM_PN.PART_DESC2  is '規格';
comment on column shinewave.NPI_FORM_PN.LONGTERM_WEEK is 'long L/T(weeks) 資料由Tip Top 來';
comment on column shinewave.NPI_FORM_PN.PN_PROPERTY  is '料號屬性。Ref(NPI_PN_Property)';
comment on column shinewave.NPI_FORM_PN.ADD2_SOURCE  is '加入第二來源。Ref(NPI_PN_Add2Source)';
comment on column shinewave.NPI_FORM_PN.ADD2_SOURCE_COMMENT  is '加入第二來源備註';
comment on column shinewave.NPI_FORM_PN.EOL_COMMENT  is 'EOL備註';
comment on column shinewave.NPI_FORM_PN.CREATE_USER  is '新增人員';
comment on column shinewave.NPI_FORM_PN.CREATE_DATE  is '新增日期';
comment on column shinewave.NPI_FORM_PN.UPDATE_USER  is '更新人員';
comment on column shinewave.NPI_FORM_PN.UPDATE_DATE  is '更新日期';
comment on column shinewave.NPI_FORM_PN.ALERT  is '是否提醒';
comment on column shinewave.NPI_FORM_PN.ASSEMBLY_NO  is '料號群組';
comment on column shinewave.NPI_FORM_PN.ASSEMBLY_TYPE  is '主/替代料(N=主料 S=替代料)';
comment on column shinewave.NPI_FORM_PN.RISKBUY  is 'RiskBuy(Y=是,N=不是)';

alter table shinewave.NPI_FORM_PN
  add constraint PK_NPI_FORM_PN primary key (FORM_ID, ASUS_PN)
  using index ;

alter table shinewave.NPI_FORM_PN
  add constraint FK_NPI_FORM_PN_ADDSOUCER foreign key (ADD2_SOURCE)
  references shinewave.NPI_PN_ADD2SOURCE (SOURCE_ID);

alter table shinewave.NPI_FORM_PN
  add constraint FK_NPI_FORM_PN_PROPERTY foreign key (PN_PROPERTY)
  references shinewave.NPI_PN_PROPERTY (PROPERTY_ID);


create table shinewave.NPI_FORM_SUB
(
  FORM_ID       NVARCHAR2(20) not null,
...
comment on table  shinewave.NPI_FORM_SUB  is 'NPI PM 表單資料表';
comment on column shinewave.NPI_FORM_SUB.FORM_ID  is '表單代號';
comment on column shinewave.NPI_FORM_SUB.PM_USER_ID  is '負責PM員工工號';
comment on column shinewave.NPI_FORM_SUB.PM_COMPANY_ID  is '負責PM員工公司';

alter table shinewave.NPI_FORM_SUB  add constraint PK_FORM_SUB primary key (FORM_ID, PM_USER_ID)
  using index ;


create table shinewave.NPI_FORM_TEMP
(
  FORM_ID    NVARCHAR2(20) not null,
  USER_ID    NVARCHAR2(20) not null,
  COMPANY_ID NVARCHAR2(60) not null
...
alter table shinewave.NPI_FORM_TEMP
  add constraint PK_NPI_FORM_TEMP primary key (FORM_ID, USER_ID, COMPANY_ID)
  using index;


create table shinewave.NPI_PN_GROUP
(
  GROUP_ID   NVARCHAR2(10) not null,
  GROUP_NAME NVARCHAR2(20)
) tablespace tp_rd;
comment on column shinewave.NPI_PN_GROUP.GROUP_ID  is '元件料號前置字元代號';
comment on column shinewave.NPI_PN_GROUP.GROUP_NAME  is '元件料號名稱';

alter table shinewave.NPI_PN_GROUP  add constraint PK_COMPONENT_ID primary key (GROUP_ID)
  using index ;


create table shinewave.NPI_PN_SOURCER
(
  USER_ID    NVARCHAR2(20) not null,
...
alter table shinewave.NPI_PN_SOURCER
  add constraint PK_NPI_PN_SOURCER_ID primary key (USER_ID, GROUP_ID)
  using index ;


create table shinewave.NPI_ROLE
(
...
comment on column shinewave.NPI_ROLE.ROLE_ID  is '角色代號';
comment on column shinewave.NPI_ROLE.ROLE_NAME  is '角色名稱';
comment on column shinewave.NPI_ROLE.CREATE_DATE  is '建立時間';
comment on column shinewave.NPI_ROLE.CREATE_USER  is '建立人員';
comment on column shinewave.NPI_ROLE.UPDATE_DATE  is '更新時間';
comment on column shinewave.NPI_ROLE.UPDATE_USER  is '更新人員';

alter table shinewave.NPI_ROLE
  add constraint PK_ROLE_ID primary key (ROLE_ID)
  using index ;


create table shinewave.NPI_PRIVILEGE
(
...
comment on table  shinewave.NPI_PRIVILEGE  is 'NPI 權限列表';
comment on column shinewave.NPI_PRIVILEGE.USER_ID  is '員工工號';
comment on column shinewave.NPI_PRIVILEGE.USER_NAME  is '員工名稱';
comment on column shinewave.NPI_PRIVILEGE.ROLE_ID  is '角色';
comment on column shinewave.NPI_PRIVILEGE.CREATE_DATE  is '新增日期';
comment on column shinewave.NPI_PRIVILEGE.CREATE_USER  is '新增人員';
comment on column shinewave.NPI_PRIVILEGE.UPDATE_DATE  is '更新時間';
comment on column shinewave.NPI_PRIVILEGE.UPDATE_USER  is '更新人員';
comment on column shinewave.NPI_PRIVILEGE.IS_ENABLE  is '是否啟用Y/N';
comment on column shinewave.NPI_PRIVILEGE.COMPANY_ID  is '公司';

alter table shinewave.NPI_PRIVILEGE
...
alter table shinewave.NPI_PRIVILEGE
  ...
  references shinewave.NPI_ROLE (ROLE_ID);


alter table shinewave.NPI_BOM disable all triggers;
alter table shinewave.NPI_FORM_MAIN disable all triggers;
alter table shinewave.NPI_BOM_PN disable all triggers;
alter table shinewave.NPI_BOOKING disable all triggers;
alter table shinewave.NPI_PN_ADD2SOURCE disable all triggers;
alter table shinewave.NPI_PN_PROPERTY disable all triggers;
alter table shinewave.NPI_FORM_PN disable all triggers;
alter table shinewave.NPI_FORM_SUB disable all triggers;
alter table shinewave.NPI_FORM_TEMP disable all triggers;
alter table shinewave.NPI_PN_GROUP disable all triggers;
alter table shinewave.NPI_PN_SOURCER disable all triggers;
alter table shinewave.NPI_ROLE disable all triggers;
alter table shinewave.NPI_PRIVILEGE disable all triggers;
alter table shinewave.NPI_BOM_PN disable constraint FK_NPI_BOM_PN_FORM;
alter table shinewave.NPI_FORM_PN disable constraint FK_NPI_FORM_PN_ADDSOUCER;
alter table shinewave.NPI_FORM_PN disable constraint FK_NPI_FORM_PN_PROPERTY;
alter table shinewave.NPI_PRIVILEGE disable constraint FK_USER_ROLE_ROLE_ID;

delete from shinewave.NPI_PRIVILEGE;
commit;
...
insert into shinewave.NPI_PN_GROUP (GROUP_ID, GROUP_NAME)
values ('01', '01*CPU');
insert into shinewave.NPI_PN_GROUP (GROUP_ID, GROUP_NAME)
...
prompt Loading shinewave.NPI_PN_SOURCER...
insert into shinewave.NPI_PN_SOURCER (USER_ID, GROUP_ID, COMPANY_ID)
...
prompt Loading shinewave.NPI_ROLE...
insert into shinewave.NPI_ROLE (ROLE_ID, ROLE_NAME, CREATE_DATE, CREATE_USER, UPDATE_DATE, UPDATE_USER)
...
prompt Loading shinewave.NPI_PRIVILEGE...
insert into shinewave.NPI_PRIVILEGE (USER_ID, USER_NAME, ROLE_ID, CREATE_DATE, CREATE_USER, UPDATE_DATE, UPDATE_USER, IS_ENABLE, COMPANY_ID)
...
prompt Enabling foreign key constraints for shinewave.NPI_BOM_PN...
alter table shinewave.NPI_BOM_PN enable constraint FK_shinewave.NPI_BOM_PN_FORM;
prompt Enabling foreign key constraints for shinewave.NPI_FORM_PN...
alter table shinewave.NPI_FORM_PN enable constraint FK_shinewave.NPI_FORM_PN_ADDSOUCER;
alter table shinewave.NPI_FORM_PN enable constraint FK_shinewave.NPI_FORM_PN_PROPERTY;
prompt Enabling foreign key constraints for shinewave.NPI_PRIVILEGE...
alter table shinewave.NPI_PRIVILEGE enable constraint FK_USER_ROLE_ROLE_ID;
prompt Enabling triggers for shinewave.NPI_BOM...
alter table shinewave.NPI_BOM enable all triggers;
prompt Enabling triggers for shinewave.NPI_FORM_MAIN...
alter table shinewave.NPI_FORM_MAIN enable all triggers;
prompt Enabling triggers for shinewave.NPI_BOM_PN...
alter table shinewave.NPI_BOM_PN enable all triggers;
prompt Enabling triggers for shinewave.NPI_BOOKING...
alter table shinewave.NPI_BOOKING enable all triggers;
prompt Enabling triggers for shinewave.NPI_PN_ADD2SOURCE...
alter table shinewave.NPI_PN_ADD2SOURCE enable all triggers;
prompt Enabling triggers for shinewave.NPI_PN_PROPERTY...
alter table shinewave.NPI_PN_PROPERTY enable all triggers;
prompt Enabling triggers for shinewave.NPI_FORM_PN...
alter table shinewave.NPI_FORM_PN enable all triggers;
prompt Enabling triggers for shinewave.NPI_FORM_SUB...
alter table shinewave.NPI_FORM_SUB enable all triggers;
prompt Enabling triggers for shinewave.NPI_FORM_TEMP...
alter table shinewave.NPI_FORM_TEMP enable all triggers;
prompt Enabling triggers for shinewave.NPI_PN_GROUP...
alter table shinewave.NPI_PN_GROUP enable all triggers;
prompt Enabling triggers for shinewave.NPI_PN_SOURCER...
alter table shinewave.NPI_PN_SOURCER enable all triggers;
prompt Enabling triggers for shinewave.NPI_ROLE...
alter table shinewave.NPI_ROLE enable all triggers;
prompt Enabling triggers for shinewave.NPI_PRIVILEGE...
alter table shinewave.NPI_PRIVILEGE enable all triggers;

CREATE SYNONYM NPI_BOM 					FOR shinewave.NPI_BOM;
CREATE SYNONYM NPI_FORM_MAIN 		FOR shinewave.NPI_FORM_MAIN;
CREATE SYNONYM NPI_BOM_PN 				FOR shinewave.NPI_BOM_PN;
CREATE SYNONYM NPI_BOOKING 			FOR shinewave.NPI_BOOKING;
CREATE SYNONYM NPI_PN_ADD2SOURCE FOR shinewave.NPI_PN_ADD2SOURCE;
CREATE SYNONYM NPI_PN_PROPERTY 	FOR shinewave.NPI_PN_PROPERTY;
CREATE SYNONYM NPI_FORM_PN 			FOR shinewave.NPI_FORM_PN;
CREATE SYNONYM NPI_FORM_SUB 			FOR shinewave.NPI_FORM_SUB;
CREATE SYNONYM NPI_FORM_TEMP 		FOR shinewave.NPI_FORM_TEMP;
CREATE SYNONYM NPI_PN_GROUP 			FOR shinewave.NPI_PN_GROUP;
CREATE SYNONYM NPI_PN_SOURCER 		FOR shinewave.NPI_PN_SOURCER;
CREATE SYNONYM NPI_ROLE 					FOR shinewave.NPI_ROLE;
CREATE SYNONYM NPI_PRIVILEGE 		FOR shinewave.NPI_PRIVILEGE;
