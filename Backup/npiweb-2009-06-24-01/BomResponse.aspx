...
<%@ Register Src="UserControl/UCGenList.ascx" TagName="UCGenList" TagPrefix="uc5" %>
            ...
            <tr>
                <td valign="top">
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td align="right">
                                                                        ...
                                                                        <asp:HyperLink ID="hy1" runat="server" NavigateUrl="~/Excel/NPI 如何上傳PN 資料.doc" Text="上傳Excel需知"></asp:HyperLink>
                    ...
                    <table width="100%">
                        <tr>
                            <td>
                                <asp:Panel ID="pnlQuery3" runat="Server" Visible="False">
                                    
                                    <uc5:UCGenList id="UCGenList1" runat="server" OnResultClick="Result2_Click">
                                    </uc5:UCGenList>
