...
namespace AsusLibrary.Entity
{
    /// <summary>
    /// 取代先前的ResponseEntity 
    /// 名稱取得不好，從新修正為Form與PN的關係
    /// </summary>
    public class FormPNEntity:BaseEntity
    {
        /// <summary>
        /// 資料表 NPI_FORM_PN
        /// </summary>
        public const string TABLE_NPI_FORM_PN = "NPI_FORM_PN";
        ...
        /// 最重要的 Model
        /// </summary>
        [Tables(FormPNEntity.TABLE_NPI_FORM_PN, PageCommandType.InsertColumnMode, DBCommandType.InsertMode, "", null)]
        [Tables(FormPNEntity.TABLE_NPI_FORM_PN, PageCommandType.UpdateColumnMode, DBCommandType.UpdateMode, " where form_id='{0}' and asus_pn='{1}'", new string[] { "FormId", "PN"})]
        public FormPNEntity()
        { }
        ...
        /// </summary>
        [DataColumn("FORM_ID")]
        [InsertColumn(FormPNEntity.TABLE_NPI_FORM_PN, "FORM_ID", Asus.Data.DataType.NVarChar)]
