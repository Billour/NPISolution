...
{
    [Version(GroupId = "NPI", Version = 3)]
    [Schema(SchemaName = "scm", TypeName = SchemaType.Oracle)]
    public class NPIVersion3
    {
        [Action(Seq = 1, Control = EnumDbControl.Table, Mode = EnumDbMode.Create)]
        [Table(TableName = "NPI_Group", ChineseName = "NPI 群組", TableSpace = "SCM", IndexSpace = "INDX", Seq = 10)]
        ...
        /// </summary>
        [Action(Seq = 1, Control = EnumDbControl.Table, Mode = EnumDbMode.Create)]
        [Table(TableName = "NPI_Group_Mapping", ChineseName = "NPI 群組 人員", TableSpace = "SCM", IndexSpace = "INDX", Seq = 20)]
